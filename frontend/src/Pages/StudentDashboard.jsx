...
//       try {
//         const res = await fetch(`https://ll-4.onrender.com/api/materials?classLevel=${selectedClass}`);
...
//       window.open(`https://ll-4.onrender.com/api/materials/download/${material.publicId}`, '_blank');
...
//       try {
//         const res = await fetch(`https://ll-4.onrender.com/api/discussions?classLevel=${selectedClass}`);
//         const data = await res.json();
...
//         };
//         const res = await fetch('https://ll-4.onrender.com/api/discussions', {
//           method: 'POST',
...
//                       classLevel: selectedClass
//                     };
//                     const res = await fetch('https://ll-4.onrender.com/api/suggestions', {
//                       method: 'POST',
//                       headers: { 'Content-Type': 'application/json' },
...
const StudentDashboard = () => {
  ...
  const handleDownloadMaterial = (material, mode = "inline") => {
    ...
    if (material.publicId) {
      const url = `https://ll-4.onrender.com/api/materials/download/${material.publicId}?mode=${mode}&name=${encodeURIComponent(material.title)}`;
